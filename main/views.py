...
def detail(request, rubric_pk, pk):
    ...
    if request.method == 'POST':
        ...
        if c_form.is_valid():
            c_form.save()
            messages.add_message(request, messages.SUCCESS, message='Комментарий добавлен')
        else:
            form = c_form
            messages.add_message(request, messages.WARNING, message='Комментарий не добавлен')
